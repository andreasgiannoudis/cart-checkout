...
<form id="form" class="variations_form cart" action="<?php echo esc_url(apply_filters('woocommerce_add_to_cart_form_action', $product->get_permalink())); ?>" method="post" enctype='multipart/form-data' data-product_id="<?php echo absint($product->get_id()); ?>" data-product_variations="<?php echo $variations_attr; // WPCS: XSS ok. 
																																																																								?>">
							...
							<div class="attribute-options">
								<?php if ($attribute_name === 'Size') : ?>
									<div class="select-values-div">
										<span class="select-values"> <?= wc_attribute_label($attribute_name); ?> <span id="value-of-the-option-size" class="value-of-the-option-size"></span></span>									</div>
